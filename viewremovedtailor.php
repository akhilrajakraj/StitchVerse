...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: removedtailors.php");
    exit();
}
$tailor_id = intval($_GET['id']);
$db = new DatabaseCon();

// Fetch Removed Tailor Details
$tailor = null;
$sql_tailor = "SELECT * FROM treg WHERE tid = ? AND status = 'Removed'";
...
if ($result_tailor && $result_tailor->num_rows > 0) {
    ...
    $_SESSION['action_error'] = "Removed tailor not found.";
    header("Location: removedtailors.php");
    exit();
}
?>
...
<head>
    ...
    <title>Removed Tailor Details - <?php echo htmlspecialchars($tailor['tname']); ?></title>
...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto px-6 py-12">
        ...
        <div class="mb-6">
            <a href="removedtailors.php" class="inline-flex items-center gap-2 text-gray-600 hover:text-purple-600 font-medium text-sm transition-colors">
                <i class="ri-arrow-left-line"></i>
                <span>Back to Removed Tailors List</span>
            </a>
        </div>
