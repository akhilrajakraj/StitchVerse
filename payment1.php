                    ...
                    <div class="p-6 bg-gray-50/70">
                        ...
                        <div class="bg-white p-4 rounded-lg border">
                            <div class="flex items-start gap-4">
                                <img src="<?php echo htmlspecialchars(!empty($order['simg']) ? $order['simg'] : 'placeholder.jpg'); ?>" class="w-20 h-24 object-cover rounded-md flex-shrink-0">
                                <div>
                                    <h4 class="font-semibold text-gray-800"><?php echo htmlspecialchars($order['sdname']); ?></h4>
                                    <p class="text-sm text-gray-500">Tailor: <?php echo htmlspecialchars($order['tname']); ?></p>
                                </div>
                            </div>
                            <div class="mt-4 space-y-2 text-sm border-t pt-4">
                                <div class="flex justify-between"><span class="text-gray-600">Stitching Price:</span><span class="font-medium text-gray-900">₹<?php echo number_format($order['sprice']); ?></span></div>
                                ...
                                <div class="flex justify-between text-base font-bold text-gray-800 border-t pt-2 mt-2"><span >Total Payable:</span><span class="text-purple-600">₹<?php echo number_format($order['sprice'] + 40); ?></span></div>
                            </div>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <form id="payment-form" action="payaction.php" method="POST" novalidate>
                            <input type="hidden" name="order_id" value="<?php echo htmlspecialchars($order['sdid']); ?>">
                            <input type="hidden" name="amount" value="<?php echo htmlspecialchars($order['sprice']); ?>">
                            <div class="space-y-5">
                                <div>
                                ...
                                <div class="pt-2">
                                    <button id="submit-btn" type="submit" class="w-full py-3 bg-purple-600 text-white rounded-lg font-semibold shadow-md transition-all flex items-center justify-center gap-2 btn-disabled">
                                        <i class="ri-shield-check-line"></i> <span>Pay ₹<?php echo number_format($order['sprice'] + 40); ?> Securely</span>
                                    </button>
                                    <a href="stitchrequest_details.php?id=<?php echo htmlspecialchars($order['sdid']); ?>" class="block text-center text-sm text-gray-600 hover:text-purple-600 mt-4">Cancel and Go Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
