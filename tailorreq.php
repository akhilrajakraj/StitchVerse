...
$sql = "SELECT
        ...
        WHERE
            sr.tid = 0 AND sr.sstatus = 'Pending'
        ORDER BY
            sr.sddate ASC";
...
<head>
    ...
    <title>General Custom Requests - StitchVerse</title>
                ...
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white">General Custom Requests</h1>
                                <p class="text-purple-100 mt-1">New job opportunities available for all tailors.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-600">
                       <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        ...
                        <tbody>
                            <?php if (empty($general_requests)): ?>
                                <tr><td colspan="6" class="px-6 py-10 text-center text-gray-500">There are no general requests available at this time.</td></tr>
                            <?php else: ?>
                                <?php foreach ($general_requests as $request): ?>
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="viewgeneralreqdetails.php?id=<?php echo $request['sdid']; ?>" class="font-medium text-purple-600 hover:text-purple-800 text-xs inline-flex items-center gap-1">
