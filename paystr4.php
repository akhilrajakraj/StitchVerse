...
$db = new DatabaseCon();
$order_id = $_GET['id']; // This is the stitch request ID (sdid)
...
$sql = "SELECT 
            ...
            s.sdid, s.sdname, s.sprice, s.simg,
...
<head>
    ...
    <title>Payment Details - Request #<?php echo htmlspecialchars($details['sdid']); ?> - StitchVerse</title>
    ...
    <main class="container mx-auto px-6 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <a href="stitchrequest_details.php?id=<?php echo $details['sdid']; ?>" class="inline-block mb-2 text-sm font-medium text-purple-600 hover:text-purple-800 transition-colors">&larr; Back to Request Details</a>
                    <h1 class="text-3xl font-bold text-gray-800">Payment Details</h1>
                </div>
                <a href="receipt3.php?order_id=<?php echo $details['sdid']; ?>" target="_blank" class="px-4 py-2 bg-gray-800 text-white text-sm text-center rounded-lg hover:bg-black font-semibold flex items-center justify-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-b pb-6">
                    ...
                    <div class="md:text-right">
                        ...
                        <p class="text-gray-600 text-sm"><span class="font-semibold text-gray-800">Request ID:</span> #<?php echo htmlspecialchars($details['sdid']); ?></p>
                ...
                <div class="py-6 border-b">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800"><?php echo htmlspecialchars($details['card_name'] ?? 'Card Payment'); ?></p>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center bg-gray-50 p-3 rounded-md">
                            <div class="flex items-center gap-4">
                                <img src="<?php echo htmlspecialchars($details['simg']); ?>" class="w-12 h-16 object-cover rounded-md border">
                                <div>
                                    <p class="font-bold text-gray-800"><?php echo htmlspecialchars($details['sdname']); ?></p>
                                    <p class="text-sm text-gray-500">Custom Request for <?php echo htmlspecialchars($details['tname']); ?></p>
                                </div>
                            </div>
                            <p class="text-md font-semibold text-gray-800">₹<?php echo number_format($details['sprice']); ?></p>
                        </div>
                        <div class="flex justify-between text-gray-600 text-sm">
                            <span>Stitching Price</span>
                            <span>₹<?php echo number_format($details['sprice']); ?></span>
                        </div>
                         <div class="flex justify-between text-gray-600 text-sm">
                        ...
                        <div class="flex justify-between text-lg font-bold text-gray-800 border-t pt-3 mt-2">
                            ...
                            <span class="text-purple-600">₹<?php echo number_format($details['sprice'] + 40); ?></span>
                        </div>
                    </div>
                </div>
