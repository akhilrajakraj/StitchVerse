...
// --- Data Fetching Logic ---
// This query finds all stitch requests that have been rejected by the logged-in tailor.
$rejected_requests = [];
$sql = "SELECT
            sr.sdid,
            sr.sddate,
        ...
        WHERE
            sr.tid = ? AND sr.sstatus = 'Rejected'
        ORDER BY
            sr.sddate DESC";
...
<head>
    ...
    <title>Rejected Requests - StitchVerse</title>
...
<body class="bg-gradient-to-br from-purple-50 to-pink-50 min-h-screen">
    ...
    <!-- === HEADER: WITH ACTIVE STATE FOR 'REJECTED REQUESTS' === -->
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mr-4">
                                <i class="ri-close-circle-line text-2xl text-white"></i>
                            </div>
                            <div>
                                <h1 class="text-3xl font-bold text-white">Rejected Requests</h1>
                                <p class="text-purple-100 mt-1">A history of job requests that you have rejected.</p>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        ...
                        <tbody>
                            <?php if (empty($rejected_requests)): ?>
                                <tr><td colspan="7" class="px-6 py-10 text-center text-gray-500">You have not rejected any requests.</td></tr>
                            <?php else: ?>
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="viewrejectedreqdetails.php?id=<?php echo $request['sdid']; ?>" class="font-medium text-purple-600 hover:text-purple-800 text-xs inline-flex items-center gap-1">
