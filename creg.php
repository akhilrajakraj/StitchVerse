...
<head> 
    ...
    <title>Customer Registration - StitchVerse</title> 
...
<body class="bg-gray-100"> 
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <a href="creg.php" class="bg-purple-600 text-white px-4 py-2 rounded-lg text-sm font-semibold">Customer Register</a>
    ...
    <main class="flex items-center justify-center py-16 px-4" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/backgroundindex.jpg'); background-size: cover; background-position: center;"> 
        ...
        <div class="w-full max-w-2xl mx-auto p-8 bg-white rounded-2xl shadow-xl"> 
            <a href="index.php" class="text-3xl font-bold text-purple-600 font-pacifico block text-center mb-2">StitchVerse</a> 
            <h2 class="text-2xl font-bold text-gray-800 text-center mb-6">Create Your Customer Account</h2> 
            <form id="registration-form" action="cregaction.php" method="POST" novalidate> 
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6"> 
                    <div class="mb-4"> 
                        <label for="cname" class="block mb-2 text-sm font-medium text-gray-700">Full Name</label> 
                        <input type="text" id="cname" name="cname" class="input-field" placeholder="Enter your full name" required> 
                        <div id="cname-error" class="form-error"></div> 
                    </div> 
                    <div class="mb-4"> 
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-700">Email Address (Gmail Only)</label> 
                        <input type="email" id="email" name="email" class="input-field" placeholder="you@gmail.com" required> 
                        <div id="email-error" class="form-error"></div> 
                    </div> 
                    <div class="mb-4 md:col-span-2"> 
                        <label for="address" class="block mb-2 text-sm font-medium text-gray-700">Full Address</label> 
                        <textarea id="address" name="address" class="input-field" placeholder="House Name, Street, PO" rows="2" required></textarea> 
                    ...
                    <div class="mb-4"> 
                        <label for="distr" class="block mb-2 text-sm font-medium text-gray-700">District</label> 
                        <select id="distr" name="distr" class="input-field" required> 
                        ...
                        <div id="distr-error" class="form-error"></div> 
                    </div> 
                    <div class="mb-4"> 
                    ...
                    <div class="mb-4"> 
                        <label for="pincode" class="block mb-2 text-sm font-medium text-gray-700">6-Digit Pincode</label> 
                        <input type="text" id="pincode" name="pincode" class="input-field" placeholder="e.g., 690101" required maxlength="6"> 
                ...
                <button type="submit" class="w-full mt-4 bg-purple-600 text-white py-3 rounded-lg font-semibold text-lg hover:bg-purple-700 transition-colors">Register</button> 
    ...
    <script> 
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const validations = { 
                cname: value => value.length < 3 ? 'Name must be at least 3 characters.' : '', 
                email: value => {
                ...
                distr: value => !value ? 'Please select a district.' : '', 
                phone: value => !/^[0-9]{10}$/.test(value) ? 'Phone number must be exactly 10 digits.' : '', 
                pincode: value => !/^[0-9]{6}$/.test(value) ? 'Pincode must be exactly 6 digits.' : '', 
                password: value => {
            ...
            if (urlParams.get('success') === 'true') { 
                ...
                showModal('Registration Successful!', `Welcome, ${customerName}! You can now log in.`, 'success'); 
            } 
            <?php 
