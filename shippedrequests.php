...
// --- Fetch stats for shipped requests ---
$sql_total_shipped = "SELECT COUNT(sdid) as count FROM stitchreq WHERE sstatus = 'Shipped'";
$total_shipped = $db->selectData($sql_total_shipped)->fetch_assoc()['count'];

// --- Build the main query securely ---
$sql_main = "SELECT sr.sdid, sr.sdname, sr.sstatus, sr.simg, c.cname, t.tname 
             FROM stitchreq sr
             JOIN creg c ON sr.uid = c.cid
             LEFT JOIN treg t ON sr.tid = t.tid
             WHERE sr.sstatus = 'Shipped'";
$types = "";
$params = [];
...
if (!empty($search_term)) {
    ...
    $types = "sss";
    $params = [$searchTermLike, $searchTermLike, $searchTermLike];
}
...
<head>
    ...
    <title>Shipped Stitch Requests - StitchVerse Admin</title>
...
<body class="bg-gray-100">
          ...
          <div class="relative">
            ...
            <div class="relative">
                ...
                <div id="stitch-dropdown-menu" class="hidden absolute mt-2 w-48 bg-white rounded-lg shadow-xl py-2 z-20 border border-gray-100">
                    ...
                    <a href="shippedrequests.php" class="block px-4 py-2 text-sm text-purple-600 bg-purple-50 font-semibold">Shipped Requests</a>
    ...
    <main class="container mx-auto px-6 py-12">
        <div class="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Shipped Stitch Requests</h1>
                <p class="text-gray-500 mt-1">Review all completed and shipped tailoring jobs.</p>
            </div>
            <div class="bg-gradient-to-br from-green-100 to-green-200 p-4 rounded-xl text-center">
                <div class="text-3xl font-bold text-green-700"><?php echo $total_shipped; ?></div>
                <div class="text-green-700 text-sm font-medium">Total Shipped</div>
            </div>
        </div>

        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <form method="get" action="shippedrequests.php" class="flex items-center justify-end">
                    <div class="relative">
                ...
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody>
                        <?php if (empty($requests)): ?>
                            <tr><td colspan="5" class="px-6 py-16 text-center"><i class="ri-archive-line text-5xl text-gray-300"></i><h3 class="text-xl font-semibold text-gray-800 mt-4">No Shipped Requests Found</h3><p class="text-gray-500 mt-1">No orders have been marked as shipped yet.</p></td></tr>
                        <?php else: ?>
