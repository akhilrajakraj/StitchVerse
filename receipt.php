...
// Full Stack Enhancement: Securely fetch data for the receipt and verify ownership.
$sql = "SELECT
            p.order_id, p.pdate,
            s.sdname, s.sdtype, s.sprice, s.sddate,
...
<body class="bg-gray-100">
    ...
    <div class="no-print container mx-auto px-6 py-4 flex items-center justify-between">
        <a href="paystr.php?id=<?php echo htmlspecialchars($receipt['order_id']); ?>" class="text-sm text-gray-600 hover:text-purple-600 flex items-center gap-2">
        ...
        <div class="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-lg">
            ...
            <div class="grid md:grid-cols-2 gap-8 mt-8">
                <div>
                    ...
                    <p class="text-gray-600"><?php echo htmlspecialchars($receipt['address']); ?></p>
                    <p class="text-gray-600"><?php echo htmlspecialchars($receipt['city']); ?>, <?php echo htmlspecialchars($receipt['pincode']); ?></p>
                </div>
                <div class="md:text-right">
                    <h2 class="text-sm font-semibold text-gray-500 uppercase mb-2">Payment Details</h2>
                    <p class="text-gray-600"><strong>Payment Date:</strong> <?php echo date("d M, Y", strtotime($receipt['pdate'])); ?></p>
                    <p class="text-gray-600"><strong>Order Date:</strong> <?php echo date("d M, Y", strtotime($receipt['sddate'])); ?></p>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            <td class="px-6 py-4">
                                ...
                                <p class="text-sm text-gray-600">(Custom Stitch Request)</p>
                            </td>
            ...
            <div class="mt-8 flex justify-end">
                <div class="w-full max-w-xs space-y-3">
                    ...
                    <div class="flex justify-between text-lg font-bold text-gray-800 border-t pt-3 mt-2"><span>Total Paid</span><span class="text-purple-600">₹<?php echo number_format($receipt['sprice'], 2); ?></span></div>
                </div>
            </div>

            <div class="mt-12 border-t pt-6 text-center">
                <p class="text-gray-600 font-semibold">Thank you for your business!</p>
                <p class="text-xs text-gray-500 mt-1">This is a digital receipt for your records.</p>
            </div>
        </div>
    </main>
