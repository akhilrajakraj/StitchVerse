...
// --- Data Fetching Logic ---
// We query the treg table for tailors with the status 'Removed'
$removed_tailors = [];
$sql = "SELECT tid, tname, email, phone, city, distri FROM treg WHERE status = 'Removed' ORDER BY tname ASC";
...
<head>
    ...
    <title>Removed Tailors - StitchVerse Admin</title>
...
<body class="bg-gray-100">
    ...
    <!-- === HEADER WITH ACTIVE STATE FOR 'REMOVED TAILORS' === -->
          ...
          <nav class="hidden md:flex items-center space-x-8">
            ...
            <div class="relative">
                ...
                <div id="tailor-dropdown-menu" class="hidden absolute mt-2 w-48 bg-white rounded-lg shadow-xl py-2 z-20 border border-gray-100">
                   ...
                   <a href="removedtailors.php" class="block px-4 py-2 text-sm text-purple-600 bg-purple-50 font-semibold">Removed Tailors</a>
                </div>
            </div>
    ...
    <main class="container mx-auto px-6 py-12">
        ...
        <div class="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Removed Tailors</h1>
                <p class="text-gray-500 mt-1">A historical log of all tailor accounts removed by an administrator.</p>
            </div>
            <div class="bg-gradient-to-br from-gray-200 to-gray-300 p-4 rounded-xl text-center shrink-0">
                <div class="text-3xl font-bold text-gray-700"><?php echo count($removed_tailors); ?></div>
                <div class="text-gray-700 text-sm font-medium">Removed Accounts</div>
            </div>
        </div>

        <!-- Removed Tailors Table -->
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600">
                   <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                    ...
                    <tbody>
                        <?php if (empty($removed_tailors)): ?>
                            <tr><td colspan="4" class="px-6 py-10 text-center text-gray-500">No removed tailor accounts found.</td></tr>
                        <?php else: ?>
                            <?php foreach ($removed_tailors as $tailor): ?>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="viewremovedtailor.php?id=<?php echo $tailor['tid']; ?>" class="font-medium text-purple-600 hover:text-purple-800 text-xs inline-flex items-center gap-1">
