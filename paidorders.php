...
// that HAVE a corresponding 'Paid' entry in the payment table.
$paid_orders = [];
$sql = "SELECT
            od.oid,
            od.orderdate,
...
<head>
    ...
    <title>Paid Orders - StitchVerse</title>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mr-4">
                                <i class="ri-wallet-3-line text-2xl text-white"></i>
                            </div>
                            <div>
                                <h1 class="text-3xl font-bold text-white">Paid Orders</h1>
                                <p class="text-purple-100 mt-1">A history of all successfully paid design orders.</p>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        ...
                        <tbody>
                            <?php if (empty($paid_orders)): ?>
                                <tr><td colspan="6" class="px-6 py-10 text-center text-gray-500">You have not received any paid orders yet.</td></tr>
                            <?php else: ?>
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4"><?php echo date("M d, Y", strtotime($order['payment_date'])); ?></td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 font-bold text-green-600">₹ <?php echo number_format($order['dprice']); ?></td>
                                    <td class="px-6 py-4 text-center">
                                        <a href="viewdetailspaidord.php?id=<?php echo $order['oid']; ?>" class="font-medium text-purple-600 hover:text-purple-800 text-xs inline-flex items-center gap-1">
