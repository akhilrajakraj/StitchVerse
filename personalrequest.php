...
<head>
    ...
    <title>Personal Custom Requests - StitchVerse</title>
                ...
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white">Personal Custom Requests</h1>
                                <p class="text-purple-100 mt-1">Job requests sent directly to you by customers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        ...
                        <tbody>
                            <?php if (empty($personal_requests)): ?>
                                <tr><td colspan="6" class="px-6 py-10 text-center text-gray-500">You have no new personal requests at this time.</td></tr>
                            <?php else: ?>
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="viewpersonalreqdetails.php?id=<?php echo $request['sdid']; ?>" class="font-medium text-purple-600 hover:text-purple-800 text-xs inline-flex items-center gap-1">
