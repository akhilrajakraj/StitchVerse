...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: cancelledrequest.php");
    exit();
}
...
// --- Data Fetching Logic ---
// Fetch the cancelled request details, and also check if a payment was made.
...
$sql = "SELECT
        ...
        LEFT JOIN
            payment p ON sr.sdid = p.order_id AND p.pstatus = 'Paid'
        WHERE
            sr.sdid = ? AND sr.tid = ? AND sr.sstatus = 'Cancelled'";
...
<head>
    ...
    <title>Cancelled Request Details #<?php echo htmlspecialchars($request_details['sdid']); ?> - StitchVerse</title>
...
<body class="bg-gradient-to-br from-purple-50 to-pink-50 min-h-screen">
          ...
          <nav class="hidden md:flex items-center space-x-6">
            ...
            <div class="relative">
                ...
                <div id="custom-orders-menu" class="hidden absolute mt-2 w-56 bg-white rounded-lg shadow-xl py-2 z-20 border border-gray-100">
                    ...
                    <a href="cancelledrequest.php" class="block px-4 py-2 text-sm text-purple-600 bg-purple-50 font-semibold">Cancelled Requests</a>
                </div>
            </div>
          </nav>
    ...
    <main class="container mx-auto px-6 py-12">
        <div class="mb-6">
            <a href="cancelledrequest.php" class="inline-flex items-center gap-2 text-gray-600 hover:text-purple-600 font-medium text-sm transition-colors">
                <i class="ri-arrow-left-line"></i>
                <span>Back to Cancelled Requests</span>
            </a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden max-w-6xl mx-auto">
            <div class="bg-gradient-to-r from-gray-500 to-gray-700 p-8 text-white">
                <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                    ...
                    <div class="text-center bg-gray-800 text-white font-bold px-4 py-2 rounded-lg">
                        Cancelled
                    </div>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid sm:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                                ...
                                <?php if (!empty($request_details['sprice'])): ?>
                                <p><strong class="text-gray-500">Quoted Price:</strong><br><span class="font-medium text-gray-800">₹<?php echo htmlspecialchars(number_format($request_details['sprice'], 2)); ?></span></p>
                                <?php endif; ?>
                    ...
                    <div class="lg:col-span-1 bg-gray-50 p-6 rounded-lg border">
                        ...
                        <div class="mt-6 border-t pt-4">
                             <h3 class="text-lg font-bold text-gray-800 mb-2">Payment Status</h3>
                             <?php if (!empty($request_details['payment_id'])): ?>
                                <div class="flex items-center gap-2 text-green-600">
                                    <i class="ri-checkbox-circle-fill"></i>
                                    <p class="font-semibold">Payment was made for this order.</p>
                                </div>
                             <?php else: ?>
                                <div class="flex items-center gap-2 text-gray-600">
                                    <i class="ri-error-warning-fill"></i>
                                    <p class="font-semibold">No payment was made for this order.</p>
                                </div>
                             <?php endif; ?>
                        </div>
                    </div>
